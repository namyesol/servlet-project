...
public class FileBoardDTO {
	int file_board_no; //FILE_BOARD_NO 게시글번호
	String member_num; //MEMBER_NUM,	사원번호
	String file_board_date; //FILE_BOARD_DATE, 자료작성날짜
	String file_board_title;//	FILE_BOARD_TITLE, 자료제목
	String file_board_content;//	FILE_BOARD_CONTENT, 자료본문
	int file_board_view;//	FILE_BOARD_VIEW, 자료조회수
	String file_name;//	FILE_NAME, 원본파일 이름
	String file_rename;//FILE_RENAME, 재설정파일이름
	String file_path;//	FILE_PATH 파일경로 mainmessage
	...
	public FileBoardDTO(int file_board_no, String member_num, String file_board_date, String file_board_title,
